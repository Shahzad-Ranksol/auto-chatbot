...
| `DB_NAME` | Yes | `autochatbot` | MySQL database name |
...
mysql -u root -p -e "CREATE DATABASE autochatbot CHARACTER SET utf8mb4;"
...
6. **Start the app** and visit `https://yourdomain.com/auto-chatbot/install`
...
```bash
# Drop the database
mysql -u root -p -e "DROP DATABASE autochatbot;"
